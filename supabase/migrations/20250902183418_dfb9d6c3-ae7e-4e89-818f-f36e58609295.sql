-- Drop and recreate RPC functions to fix type mismatches
...
-- Recreate get_points_recent_activity_admin function with correct types
...
-- Recreate search_admin_users function with correct types
