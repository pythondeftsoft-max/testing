-- Update send_landlord_message to accept and save payload
...
BEGIN
  ...
  -- Insert message with the correct application_id column and payload
  IF v_application_type = 'marketplace' THEN
    INSERT INTO messages (marketplace_application_id, sender_id, message_text, created_by_tenant, payload)
    VALUES (application_id, sender_id, message_text, false, p_payload)
    RETURNING id INTO v_message_id;
  ELSIF v_application_type = 'unit' THEN
    INSERT INTO messages (unit_application_id, sender_id, message_text, created_by_tenant, payload)
    VALUES (application_id, sender_id, message_text, false, p_payload)
    RETURNING id INTO v_message_id;
  ELSIF v_application_type = 'property' THEN
    INSERT INTO messages (property_application_id, sender_id, message_text, created_by_tenant, payload)
    VALUES (application_id, sender_id, message_text, false, p_payload)
    RETURNING id INTO v_message_id;
  ELSE
...
-- Update send_tenant_message to accept and save payload
...
BEGIN
  ...
  IF v_application_type = 'marketplace' THEN
    INSERT INTO messages (marketplace_application_id, sender_id, message_text, created_by_tenant, payload)
    VALUES (application_id, sender_id, message_text, true, p_payload)
    RETURNING id INTO v_message_id;
  ELSIF v_application_type = 'unit' THEN
    INSERT INTO messages (unit_application_id, sender_id, message_text, created_by_tenant, payload)
    VALUES (application_id, sender_id, message_text, true, p_payload)
