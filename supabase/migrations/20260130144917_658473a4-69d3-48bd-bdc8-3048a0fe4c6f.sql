-- Fix handle_new_user function to use correct portfolios column names
-- The portfolios table was refactored: landlord_id -> manager_id, name -> client_name, description removed
...
BEGIN
  ...
  -- If landlord, create portfolio with CORRECT column names (manager_id, client_name)
