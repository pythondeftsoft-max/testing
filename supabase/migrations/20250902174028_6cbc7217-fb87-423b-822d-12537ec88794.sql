-- Drop existing admin functions to allow recreation with new return types
...
-- Recreate points system overview to use points_history
...
-- Recreate points monthly trends to use points_history
...
-- Recreate points recent activity to use points_history
...
-- Recreate points leaderboard to use points_history
