-- Update handle_new_user function to use "Portfolio 1" as default portfolio name
-- This prevents confusion where landlords might add all properties to a company-named portfolio
...
BEGIN
  ...
  -- This prevents confusion where landlords might add all properties to one portfolio
