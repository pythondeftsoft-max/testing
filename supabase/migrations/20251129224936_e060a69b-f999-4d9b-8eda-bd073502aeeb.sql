...
-- Recreate the function with correct column references (using unit_number and unit_name)
...
BEGIN
  ...
  -- Get property and unit details using actual column names from property_units table
  SELECT 
    p.address,
