-- Fix landlord_reject_primary_applicant to use on_market instead of listing_status
...
BEGIN
  ...
  -- Reactivate the unit listing (FIX: use on_market instead of listing_status)
  UPDATE property_units
  SET 
    on_market = true,
    updated_at = NOW()
