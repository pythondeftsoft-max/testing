-- Fix landlord_set_primary_applicant to handle property-level applications
...
BEGIN
  ...
  -- STEP 2: Now set the new primary applicant (unit_id is guaranteed to be set now)
  UPDATE property_units
  SET primary_applicant_id = p_tenant_id
  WHERE id = p_unit_id;
