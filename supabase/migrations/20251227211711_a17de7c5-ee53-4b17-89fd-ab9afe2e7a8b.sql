...
-- Recreate with fix to also update property_applications table
...
BEGIN
  ...
  -- Update marketplace_applications (existing behavior)
  ...
  -- ALSO update property_applications table (NEW - fixes the bug)
