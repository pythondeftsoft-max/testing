...
-- Recreate get_landlord_appointments with correct table name (maintenance_vendors)
...
-- Recreate get_admin_all_appointments with correct table name (maintenance_vendors)
