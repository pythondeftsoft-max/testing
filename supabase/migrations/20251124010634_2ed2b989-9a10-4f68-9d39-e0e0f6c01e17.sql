-- Fix column names in landlord_set_primary_applicant: use 'status' instead of 'application_status', remove 'application_date', add 'is_primary_applicant'
...
BEGIN
  ...
  -- Create or update unit_applications record using correct column names
