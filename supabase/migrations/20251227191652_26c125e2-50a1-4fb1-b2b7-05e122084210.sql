-- Fix landlord_set_primary_applicant to use owner_id instead of landlord_id
...
DECLARE
  ...
  v_result JSON;
BEGIN
  -- Get property_id and owner_id from the unit (fixed: was landlord_id)
  ...
  -- Clear any existing primary applicant on property_applications for this unit
