...
-- Create partial unique index to prevent overlapping active grants
CREATE UNIQUE INDEX idx_access_grants_active_unique 
ON public.access_grants (user_id, scope, COALESCE(portfolio_id, '00000000-0000-0000-0000-000000000000'::UUID), object_name, action) 
