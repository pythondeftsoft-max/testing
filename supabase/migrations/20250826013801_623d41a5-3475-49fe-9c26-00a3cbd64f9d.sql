...
-- Drop trigger first, then function, then recreate both with proper security settings

DROP TRIGGER IF EXISTS update_asset_reminder_next_date_trigger ON public.asset_reminder_preferences;
