-- Fix landlord_reject_primary_applicant to correctly look up unit when only property_id is provided
...
BEGIN
  ...
  ELSIF p_property_id IS NOT NULL THEN
    ...
    -- Update the unit: clear primary applicant and set status back to active
    UPDATE property_units
    SET 
      primary_applicant_id = NULL,
      status = 'active',
