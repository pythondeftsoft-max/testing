...
BEGIN
  ...
  -- Try property_pushes (admin push applications)
  SELECT pp.tenant_id, pp.property_id
  ...
  IF v_property_id IS NOT NULL THEN
    ...
    IF v_landlord_owns THEN
      -- For push applications, use 5-message limit (no primary applicant support yet)
