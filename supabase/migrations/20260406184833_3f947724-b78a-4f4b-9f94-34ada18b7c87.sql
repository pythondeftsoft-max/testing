...
ALTER TABLE public.tenant_profiles ADD COLUMN IF NOT EXISTS current_address TEXT;

-- Update the handle_new_user trigger to map tenant_current_address metadata
