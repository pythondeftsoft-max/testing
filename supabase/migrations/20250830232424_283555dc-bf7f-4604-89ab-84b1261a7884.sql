-- Drop all existing admin functions with their specific signatures
DROP FUNCTION IF EXISTS public.admin_get_properties_overview();
DROP FUNCTION IF EXISTS public.admin_set_property_market_status(uuid, boolean, text, jsonb);
DROP FUNCTION IF EXISTS public.admin_remove_property_tenant(uuid, text, jsonb);
DROP FUNCTION IF EXISTS public.admin_switch_property_tenant(uuid, text, text, jsonb);
...
CREATE FUNCTION public.admin_set_property_market_status(
  p_property_id uuid,
  p_on_market boolean,
...
CREATE FUNCTION public.admin_remove_property_tenant(
  p_property_id uuid,
...
CREATE FUNCTION public.admin_switch_property_tenant(
  p_property_id uuid,
