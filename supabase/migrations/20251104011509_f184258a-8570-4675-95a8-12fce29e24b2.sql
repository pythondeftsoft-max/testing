-- Function to notify on new regular messages (tenant-landlord conversations)
...
-- Create trigger for regular messages
...
-- Function to notify on new admin messages
...
DROP TRIGGER IF EXISTS admin_message_notification_trigger ON public.admin_messages;
CREATE TRIGGER admin_message_notification_trigger
