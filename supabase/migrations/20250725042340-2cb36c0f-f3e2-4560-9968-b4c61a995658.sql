...
CREATE TABLE public.tax_transactions (
    ...
    INDEX idx_tax_transactions_payee_year (payee_id, tax_year),
    INDEX idx_tax_transactions_payer_year (payer_id, tax_year),
    INDEX idx_tax_transactions_portfolio (portfolio_id),
    INDEX idx_tax_transactions_payment_date (payment_date)
);
...
CREATE TABLE public.tax_forms_1099 (
    ...
    INDEX idx_tax_forms_payer_year (payer_id, tax_year),
    INDEX idx_tax_forms_payee_year (payee_id, tax_year),
    INDEX idx_tax_forms_portfolio (portfolio_id)
);
