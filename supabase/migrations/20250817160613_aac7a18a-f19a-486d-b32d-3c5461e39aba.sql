...
CREATE INDEX idx_asset_price_history_symbol_interval ON public.asset_price_history(symbol, interval_type);
CREATE INDEX idx_asset_price_history_timestamp ON public.asset_price_history(price_timestamp DESC);
