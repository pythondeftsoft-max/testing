-- Fix notify_new_message function to use 'description' instead of 'message' column
-- The notifications table has a 'description' column, not 'message'
...
BEGIN
  ...
  -- Create notification (using 'description' column, not 'message')
