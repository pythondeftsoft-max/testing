-- Update landlord_send_lease function to allow pending/submitted applications
-- Sending the lease IS the approval action
...
BEGIN
  ...
  -- This allows pending/submitted applications to proceed - sending lease IS the approval
