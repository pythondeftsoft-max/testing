-- Add sample delinquent tenant data for comprehensive testing (fixed)
...
-- Note: Setting payment_date to a future date since it's required but payment is still pending
...
(
  ...
  25.00,
  18,
  '2025-09-01'::date + INTERVAL '30 days', -- Future expected payment date
  NOW(),
  NOW()
),
...
(
  ...
  50.00,
  35,
  '2025-08-15'::date + INTERVAL '45 days',
  NOW(),
  NOW()
),
...
(
  ...
  75.00,
  66,
  '2025-07-15'::date + INTERVAL '75 days',
  NOW(),
  NOW()
),
...
(
  ...
  100.00,
  96,
  '2025-06-15'::date + INTERVAL '120 days',
  NOW(),
  NOW()
),
...
(
  ...
  60.00,
  45,
  '2025-08-05'::date + INTERVAL '60 days',
  NOW(),
  NOW()
),
...
(
  ...
  150.00,
  120,
  '2025-05-20'::date + INTERVAL '150 days',
  NOW(),
  NOW()
);
