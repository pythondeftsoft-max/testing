-- First, delete any existing applications for this tenant for these properties
...
-- Now create fresh applications with specific IDs we can reference
DO $$
DECLARE
  app1_id uuid := '11111111-1111-1111-1111-111111111111';
  app2_id uuid := '22222222-2222-2222-2222-222222222222';
BEGIN
  -- Application 1: For 98 Euclid Ave, Brooklyn (approved status)
  INSERT INTO property_applications (id, property_id, tenant_id, status, created_at) VALUES
  (app1_id, 'adfc3472-56bd-4ed3-aee8-4bb7350ee199', '971d14a4-65e3-4a50-9187-28f3b1b2325f', 'approved', NOW() - INTERVAL '3 days');

  -- Application 2: For 123 Euclid Avenue, New York (under_review status)
  INSERT INTO property_applications (id, property_id, tenant_id, status, created_at) VALUES
  (app2_id, '5a65574e-ffda-4034-917f-f402b2bd3430', '971d14a4-65e3-4a50-9187-28f3b1b2325f', 'under_review', NOW() - INTERVAL '4 hours');
