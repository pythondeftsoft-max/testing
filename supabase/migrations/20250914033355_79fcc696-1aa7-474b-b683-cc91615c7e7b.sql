-- Add realistic test data for Accounts Receivable report (fixed)

-- Update the property to have realistic monthly rent and outstanding balance
UPDATE properties 
SET monthly_rent = 1500.00,
    outstanding_balance = 5375.00,
    last_payment_date = '2024-08-15'::date
WHERE id = '969ceaab-8dc5-4ee5-b8e2-03dcbf845f27';

-- Update property units to have monthly rent (only updating existing columns)
...
-- Create some rent payment history for realistic AR scenarios
