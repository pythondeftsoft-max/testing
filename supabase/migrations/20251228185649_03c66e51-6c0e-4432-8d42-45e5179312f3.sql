-- Fix landlord_reject_primary_applicant to use valid enum values for application_status
...
BEGIN
  ...
  -- Reject any related marketplace applications (FIX: use valid enum values)
