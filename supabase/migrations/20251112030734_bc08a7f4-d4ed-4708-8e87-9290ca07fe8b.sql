-- Fix all admin unit management functions to properly qualify is_admin calls
-- This resolves "function is_admin(uuid) does not exist" errors across all unit operations
