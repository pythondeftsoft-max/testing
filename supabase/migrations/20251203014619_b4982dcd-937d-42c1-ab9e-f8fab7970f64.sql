...
-- Recreate get_landlord_appointments WITHOUT scheduled_time, with scheduled_date as timestamptz
...
-- Recreate get_admin_all_appointments WITHOUT scheduled_time, with scheduled_date as timestamptz
