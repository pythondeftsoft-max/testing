-- Drop both versions of the function to resolve overload ambiguity
...
-- Recreate the function with correct UUID type for p_lease_document_id
...
BEGIN
  ...
  -- Get lease document name if provided
  IF p_lease_document_id IS NOT NULL THEN
    SELECT file_name
    INTO v_lease_doc_name
    FROM lease_documents
    WHERE id = p_lease_document_id;
  END IF;
