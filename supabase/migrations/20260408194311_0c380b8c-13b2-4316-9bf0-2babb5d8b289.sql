...
-- Step 1: Change monthly_income from numeric to text
ALTER TABLE public.tenant_profiles ALTER COLUMN monthly_income TYPE text USING monthly_income::text;

-- Step 2: Rewrite handle_new_user() with the fixed monthly_income line
