  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdown: "bg-background border border-input rounded px-1.5 py-0.5 text-xs font-medium cursor-pointer hover:bg-accent focus:outline-none focus:ring-1 focus:ring-ring",
